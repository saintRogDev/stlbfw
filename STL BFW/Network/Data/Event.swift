...
struct Event: Identifiable {
    ...
    private static var event2: Event {
        Event(shortTitle: "Session 314",
              ...
              description: "Get ready for convo at the cultural crossroads of hip-hop and discover the insights, stories, and experiences of St. Louis's powerhouse movers and shakers. This electrifying event promises engaging discussions, inspiring anecdotes, and a chance to connect with individuals who have left an indelible mark on our city. Doors open at 6PM CST.",
              location: Location.location2,
              link: Link.link1, image: "eve2")
    }
    ...
    private static var event4: Event {
        Event(shortTitle: "Fashion Show",
              ...
              description: "This annual event is the epitome of style and innovation, showcasing the incredible talent of 10 Amazing Saint Louis Designers. Prepare to be entertained by their collections as they hit the runway, setting the stage for an unforgettable evening of culture and entertainment. Doors open at 6PM CST.",
              location: Location.location5,
              link: Link.link3, image: "eve4")
    }
}
